                    ...
                    <tbody id="data-siswa">
                        ...
                        <tr id="siswa_id_{{$s->id}}">
                            ...
                            <td class="text-center" width="1%">
                                    ...
                                    <div class="btn-group mr-2" role="group" aria-label="First group">
                                        <button class="btn btn-danger btn-sm" id="delete-data" data-id="{{$s->id}}"><i class="fa fa-trash"></i></button>
                                        <button class="btn btn-primary btn-sm" id="edit-data" data-id="{{$s->id}}"><i class="fa fa-pen"></i></button>
                                    </div>
